...
namespace std {
	template<>
	struct hash<simperf::SmartString<std::string>> {
...
#pragma region AssertionControlFlags
	...
	inline AssertionControlFlags operator|(const AssertionControlFlags& lhs, const AssertionControlFlags& rhs) {
		return static_cast<AssertionControlFlags>(static_cast<int>(lhs) | static_cast<int>(rhs));
	}

	inline AssertionControlFlags& operator|=(AssertionControlFlags& lhs, const AssertionControlFlags& rhs) {
		return lhs = lhs | rhs;
	}
	...
	inline bool operator!(const AssertionControlFlags& value) {
...
#pragma endregion LogLevelTargeting
	...
	constexpr auto make_array(Ts&&... args) {
		return std::array<SmartString<std::string>, sizeof...(Ts)>{SmartString<std::string>(std::forward<Ts>(args))...};
	}
}